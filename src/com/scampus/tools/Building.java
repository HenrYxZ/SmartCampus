...
public class Building {
	...
	public Building(Context context, int id, String name, String description, String campus, String polygon){
	...
	public void saveBuilding(Context context){
		...
		try {
			db.execSQL("INSERT INTO Buildings (id, name, description, campus, polygon) " +
					"VALUES ("+this.id+", '"+this.name+"', '"+this.description+"', '"+this.campus+"', '"+this.polygon+"')");
