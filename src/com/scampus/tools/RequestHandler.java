...
public class RequestHandler {
	...
	public void requestUniversities(User current_user,final Context context, final Callable<Void> callback) {
		...
		String url = "http://smartcampus.ing.puc.cl/api/get_universities/"+current_user.getApiToken();
	...
	public void requestUniversitiesAndCampus(User current_user,final Context context) {
		...
		String url = "http://smartcampus.ing.puc.cl/api/get_universities_and_campuses/"+current_user.getApiToken();
	...
	public void requestBanner(User current_user,final Context context, final Callable<Void> callback) {
		...
		String url = "http://smartcampus.ing.puc.cl/api/load_banner/"+current_user.getUniversity().getID()+"/"+current_user.getApiToken();
...
//		                //EVENTOS
	...
	public void requestUserInfo(User current_user,final Context context, final Callable<Void> callback) {
		...
		String url = "http://smartcampus.ing.puc.cl/api/my_recycle_info/"+current_user.getUniversity().getID()+"/"+current_user.getApiToken();
		Log.i("REQUEST",url);
		JsonArrayRequest req = new JsonArrayRequest(url, new Response.Listener<JSONArray> () {
		    @Override
		    public void onResponse(JSONArray response) {
...
public void requestGameStatus(final User current_user,final Context context, final Callable<Void> callback) {
		...
		String url = "http://smartcampus.ing.puc.cl/api/load_game/"+current_user.getApiToken()+"/"+current_user.getAccesToken();
		Log.i("GAME",url);
		JsonArrayRequest req = new JsonArrayRequest(url, new Response.Listener<JSONArray> () {
		    @Override
		    public void onResponse(JSONArray response) {
...
//		   
	...
	public void requestCampus(User current_user,final Context context, final Callable<Void> callback) {
		...
		String url = "http://smartcampus.ing.puc.cl/api/get_campuses/"+current_user.getApiToken();
		Log.i("REQUEST",url);
		JsonArrayRequest req = new JsonArrayRequest(url, new Response.Listener<JSONArray> () {
			@Override
			public void onResponse(JSONArray response) {
	...
	public void requestClaimsCategories(User current_user,final Context context) {
		...
		String url = "http://smartcampus.ing.puc.cl/api/get_complaint_types/1/"+current_user.getApiToken();
		Log.i("REQUEST",url);
	...
	public void requestMapInfo(User current_user,final Context context) {
		...
		// Cambiar url para poner el campus id actual y no San Joaquin Harcodeado
		String url = "http://smartcampus.ing.puc.cl/api/load_campus_points/1/"+current_user.getApiToken();
		Log.i("REQUEST",url);
		JsonArrayRequest req = new JsonArrayRequest(url, new Response.Listener<JSONArray> () {
			@Override
			public void onResponse(JSONArray response) {
